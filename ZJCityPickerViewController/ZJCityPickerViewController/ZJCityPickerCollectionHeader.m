...
- (void)setAppearance:(ZJCityPickerAppearance *)appearance {
    ...
    flowLayout.itemSize = CGSizeMake(floor((width - _appearance.sectionInset.left - _appearance.sectionInset.right - (_appearance.itemsOfLine - 1) * _appearance.itemMinSpace) / _appearance.itemsOfLine) , _appearance.itemHeight);
